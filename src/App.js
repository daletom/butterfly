...
const LazyImage = ({src}) => {
  ...
  useEffect(() => {
	...
	return (
     <img alt="butterfly creek ranch" src={isVisible ? src : loading} className="w-full h-full object-center object-cover p-4" ref={rootRef} srcset={isVisible ? src + '&w=1000 1000w, ' + src + '&w=1200 1200w, ' + src + '&w=1400 1400w': ''} sizes="(min-width: 768px) 40vw, 90vw" />
	);
};
